...
public class ApiHelper extends ContextWrapper {
    ...
    public void request(String phoneNo, final RequestResponse successReceiver,
        ...
        sendRequest(R.string.url_request, phoneNo, params, new Response.Listener<JSONObject>() {
            @Override
    ...
    public void verify(String smsMessage, String phone_number, final VerifyResponse successReceiver,
                       final ApiError failureReceiver) {
        HashMap<String, String> params = new HashMap<>();
        params.put("client_secret", "123456");
        ...
        sendRequest(R.string.url_verify, phone_number, params, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Boolean success = false;
                //String phoneNo = null;
    ...
    public void reset(String phoneNo, final ResetResponse successReceiver,
        ...
        params.put("client_secret", "123456");
        params.put("phone", phoneNo);
        sendRequest(R.string.url_reset, phoneNo, params, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Boolean success = false;
                try {
    ...
    protected void sendRequest(int urlId,String phone_number, HashMap<String, String> params, Response.Listener success,
                            Response.ErrorListener failure) {
        sendRequest(getString(urlId), phone_number, params, success, failure);
    }

    protected void sendRequest(String url, String phone_number, HashMap<String, String> params, Response.Listener success,
                             Response.ErrorListener failure) {
