...
import kotlinx.android.synthetic.main.aaupdater_dlg.*
import java.text.DateFormat
import java.text.SimpleDateFormat
import java.util.*

class AAUpdaterDlg : DialogFragment() {
    ...
    private val sharedPrefFile = "laterBtn"
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.aaupdater_dlg, container)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnDontUpdate.text = resources.getText(R.string.android_app_upd_dlg_btn_no_later_txt)
        ...
        btnDontUpdate.setOnClickListener {
        ...
        when (type) {
            DlgModeEnum.UPDATE -> {
                ...
                tvInfoTxt.text = resources.getText(R.string.android_app_upd_updater_info_update)
            }
            DlgModeEnum.INSTALL -> {
                btnUpdate.text = resources.getText(R.string.cmnd_verb_android_app_upd_dlg_btn_yes_install_txt)
                tvInfoTxt.text = resources.getText(R.string.android_app_upd_updater_info_install)
            }
            DlgModeEnum.TEST -> {
                btnUpdate.text = resources.getText(R.string.cmnd_verb_android_app_upd_dlg_btn_yes_update_txt)
                tvInfoTxt.text = resources.getText(R.string.android_app_upd_updater_info_update)
    ...
    companion object {
        ...
        fun newInstance(programInfo: ProgramInfo,
                        ...
                        btnInfoActionURL: String?): AAUpdaterDlg {
            val dialog = AAUpdaterDlg()
